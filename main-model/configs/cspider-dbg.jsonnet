...
local large_setting = {
  ...
  cache_path ::  if misc_params.value_pred then "cache-cspider-dbg/exp2001" else "cache-cspider-dbg/exp304_no_values", 
...
local dataset_path = "cspider-dbg/";
...

{
  "dataset_reader": {
    ...
    "tables_file": dataset_path + "db_schema.json",
  ...
  "train_data_path": dataset_path + "debug.json",
  "validation_dataset_reader": {
    ...
    "tables_file": dataset_path + "db_schema.json",
    "dataset_path": dataset_path,
    "cache_directory": setting.cache_path + "val",
    "test_cache_directory": setting.cache_path + "test",
    "lazy": false,
  ...
  "validation_data_path": dataset_path + "debug.json",
  "test_data_path": dataset_path + "debug.json",
  "evaluate_on_test": false,

  "model": {
    "dataset_name": "cspider-dbg",
  ...
  "checkpointer": {"num_serialized_models_to_keep": 20},
    "optimizer": {
