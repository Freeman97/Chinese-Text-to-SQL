...
local large_setting = {
  ...
  cache_path ::  if misc_params.value_pred then "cache-cspider/exp2001" else "cache-cspider/exp304_no_values", 
...

{
  ...
  "checkpointer": {"num_serialized_models_to_keep": 5},
    "optimizer": {
