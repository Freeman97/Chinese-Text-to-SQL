...
local large_setting = {
  ...
  cache_path ::  if misc_params.value_pred then "cache-nl2sql-dbg/exp2001" else "cache-nl2sql-dbg/exp304_no_values", 
...

{
  ...
  "train_data_path": dataset_path + "debug_new.json",
  ...
  "validation_data_path": dataset_path + "debug_new.json",
  // "test_data_path": dataset_path + "test.json",
  "evaluate_on_test": false,

  "model": {
    "dataset_name": "nl2sql-dbg",
