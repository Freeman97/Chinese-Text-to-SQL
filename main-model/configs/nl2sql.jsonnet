...
local large_setting = {
  ...
  cache_path ::  if misc_params.value_pred then "cache-nl2sql/exp2001" else "cache-nl2sql/exp304_no_values", 
...

{
  ...
  "train_data_path": dataset_path + "train_new.json",
  ...
  "validation_data_path": dataset_path + "dev_new.json",
  ...
  "checkpointer": {"num_serialized_models_to_keep": 3},
    "optimizer": {
