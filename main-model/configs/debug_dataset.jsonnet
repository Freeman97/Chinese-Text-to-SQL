...
local large_setting = {
  ...
  cache_path ::  if misc_params.value_pred then "cache-debug_dataset/exp2001" else "cache-debug_dataset/exp304_no_values", 
...
local dataset_path = "debug_dataset/";
...

{
  ...
  "test_data_path": dataset_path + "debug-test.json",
