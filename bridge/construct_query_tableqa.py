...
def construct_query_tableqa(file_name: str, schema_file_name: str):
    ...
    for data in tqdm(data_list):
        ...
        data['query'] = query_with_backquote
...
if __name__ == '__main__':
    ...
    construct_query_tableqa('data/nl2sql/train.json', 'data/nl2sql/db_schema.json')
    construct_query_tableqa('data/nl2sql/dev.json', 'data/nl2sql/db_schema.json')
